...
class ContestController extends CommonController
{
     ...
     */
    public function index(Contest $model)
    {
        ...
        $types = config("app.{$this->entity}.contest_types", []);
     ...
     * @throws \Illuminate\Auth\Access\AuthorizationException
     */
    public function create(Contest $model)
    {
     ...
     */
    public function store(Request $request, Contest $model)
    {
     ...
     * @throws \Illuminate\Auth\Access\AuthorizationException
     */
    public function edit(Contest $model)
    {
     ...
     * @return \Illuminate\Routing\Redirector
     */
    public function update(Request $request, Contest $model)
    {
     ...
     */
    public function destroy(Request $request, Contest $model)
    {
     ...
     * @throws \Illuminate\Auth\Access\AuthorizationException
     */
    public function restore(Request $request, Contest $model)
    {
