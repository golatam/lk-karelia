<div id="filter" class="panel__filter panel__content hidden">
    <form action="{{ route("{$entity}.filter") }}" method="post" enctype="multipart/form-data" class="form" id="filter-form">
        ...
        <div class="row form__group-wrap">
            ...
            <div class="col-xs-12 col-sm-4">
                <div class="form__group form__group--input">
                    <label class="form__label form__label--medium" for="alias">@lang("{$entity}.alias")</label>
                    <input class="form__input form__input--medium" type="text" name="alias" id="alias" placeholder="@lang("common.enter_text_part")" value="{{ $filter['alias'] }}">
                </div>
            </div>
            <div class="col-xs-12 col-sm-4">
                <div class="form__group form__group--input">
                    <label class="form__label form__label--medium" for="description">@lang("{$entity}.description")</label>
                    <input class="form__input form__input--medium" type="text" name="description" id="description" placeholder="@lang("common.enter_text_part")" value="{{ $filter['description'] }}">
                </div>
            </div>
            <div class="col-xs-12">
