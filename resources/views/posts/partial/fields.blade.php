        ...
        <div class="dropdown__menu dropdown__menu--right">
            <form action="#" class="dropdown__form form" id="form-fields">
                <div class="dropdown__scroll">
                    ...
                    @foreach($fieldsForShowing as $fieldModel)
                    <label class="form__checkbox">
                        <input class="form__checkbox-input" name="td[]" type="checkbox" value="{{ $fieldModel }}" @if (in_array($fieldModel, $fieldsSelected)){{ 'checked' }}@endif>
                        <span class="form__checkbox-icon"></span>
                        <span class="form__checkbox-label">@lang("{$entity}.{$fieldModel}")</span>
                    </label>
                    @endforeach
                </div>
