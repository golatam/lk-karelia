<div id="filter" class="panel__filter panel__content hidden">
    <form action="{{ route("{$entity}.filter") }}" method="post" enctype="multipart/form-data" class="form" id="filter-form">
        ...
        <div class="row form__group-wrap">
            ...
            <div class="col-xs-12 col-sm-4">
                <div class="form__group form__group--input">
                    <label class="form__label form__label--medium" for="parent_id">@lang("{$entity}.parent_id")</label>
                    <input class="form__input form__input--medium" type="text" name="parent_id" id="parent_id" placeholder="@lang("common.enter_text_part")" value="{{ $filter['parent_id'] }}">
                </div>
            </div>
            <div class="col-xs-12 col-sm-4">
                <div class="form__group form__group--input">
