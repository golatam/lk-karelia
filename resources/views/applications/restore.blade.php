...
@section('content')
    <div class="panel">
        <div class="panel__head">
            <div class="panel__actions">
                <div class="panel__actions-item">
                    <a href="{{ route("applications.{$entity}.index") }}" class="btn btn--medium-square-xs btn--gray">
        ...
        <div class="panel__body">
            <form action="{{ route("applications.{$entity}.restore") }}" method="post" enctype="multipart/form-data" id="restore-form">
                                ...
                                @foreach($model->fieldsSelected() as $field)
                                    ...
                                    @else
                                        <th class="@if (in_array($field, $fieldsFull)){{ 'full' }}@endif">
                                            ...
                                            @else
                                                @lang("{$entity}_applications.{$field}")
                                            @endif
                                        </th>
                                    @endif
                                @endforeach
